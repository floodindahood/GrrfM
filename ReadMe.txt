...
Is intended for most shooter games that AHK can interact with and involves a weighted or non-random recoil mechanics.
...
Free to use and mostly will be up to the users to customize but, will run as is with most 
shooters given the .ini files are created according to the instructions.
